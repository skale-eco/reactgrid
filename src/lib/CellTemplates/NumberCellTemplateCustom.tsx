...
export class NumberCellTemplateCustom implements CellTemplate<NumberCell> {
  getCompatibleCell(
  ...
  update(
    ...
    return this.getCompatibleCell({
      ...cell,
      value: cell.getValueFromEvent
        ? cell.getValueFromEvent(cellToMerge.value)
        : cellToMerge.value,
    });
  }
  ...
  getClassName(cell: Compatible<NumberCell>, isInEditMode: boolean): string {
    const errorMessage = cell.validator ? cell.validator(cell.value) : null;
    const className = cell.className || "";
    return `${errorMessage ? "rg-invalid" : ""} ${className}`;
  }
